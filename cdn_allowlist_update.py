...
DEFAULTS = {
    ...
    "cdn_allowlist_static_cidrs": [
        ...
        # Публічні DNS-резолвери (1.1.1.1 і подібні потрапляють у фід X-Force і
        # тригерять UC-02-1 у кожного хоста — це найгрубіший FP). Provider-діапазони
        # Cloudflare-web (104.16/12 тощо) їх НЕ містять, тож додаємо явно.
        "1.1.1.0/24", "1.0.0.0/24",            # Cloudflare DNS
        "8.8.8.0/24", "8.8.4.0/24",            # Google DNS
        "9.9.9.0/24", "149.112.112.0/24",      # Quad9
