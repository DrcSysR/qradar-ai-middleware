...
- **AQL UC-05-1 відповідає не на те питання, що правило.** Правило детектує обхід
  корпоративного DNS, а `uc05_dns.aql` шукає DNS-тунелювання і виключає публічні резолвери
  як призначення — тобто викидає власний сигнал. Не переписано, див. запис 2026-08-24-a.
