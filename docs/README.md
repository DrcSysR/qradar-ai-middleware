...
- **handoff/** — сесійні хендоффи ISO/SOC для продовження роботи з іншого пристрою
  (не зміни мідлварі; останній — [2026-09-09: інциденти 4–9 вересня](handoff/2026-09-09-incidents-session.md)).

Керує: скіл `qradar-soc` + `CLAUDE.md` у корені репо.

| Дата | Запис |
|---|---|
| 2026-09-23 | [черга офенсів із пріоритетом за магнітудою — крок A: поллер → продюсер](changes/2026-09-23-cherha-za-mahnitudoyu.md) |
...
| 2026-09-02 | [розбір черги аналітика: 29 офенсів, переоцінка через поточний пайплайн](changes/2026-09-02-b-cherga-analityka.md) |
